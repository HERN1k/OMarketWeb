            ...
            <div className={styles.form}>
                ...
                {reviews?.map((review) => (
                    <div key={review.id} className={styles.reviewContainer}>
                        <h1 className={styles.reviewText}>Дата: <span>{toLocalDate(review.createdAt)}</span></h1>
                        <h1 className={styles.reviewText}>ID користувача: <span>{review.customerId}</span></h1>
                        <h1 className={styles.reviewText}>Відгук: </h1>
