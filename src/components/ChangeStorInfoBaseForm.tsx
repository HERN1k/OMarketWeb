...
import { IStoresFormBaseProps } from "../types/Props.interface";
import { IChangeStoreInfoBaseFrom } from "../types/Form.interface";
import { SubmitHandler, useForm } from "react-hook-form";
import { fetchChangeStoreInfoBaseAsync } from "../code/Requests";
import { modalTextChangeStoreInfoBase } from "../code/Texts";
import { Modal, Button } from "react-bootstrap";
import styles from "../styles/Form.module.css";

const ChangeStoreInfoBaseFrom: FC<IStoresFormBaseProps> = ({ showLoader, hideLoader }) => {
    ...
    const { register, handleSubmit, reset, formState: { 
        errors,
        isSubmitting
    }} = useForm<IChangeStoreInfoBaseFrom>({ mode: "all" });

    const onSubmit: SubmitHandler<IChangeStoreInfoBaseFrom> = async (data) => {
        showLoader();
        const isSuccess: boolean = await fetchChangeStoreInfoBaseAsync(data);
        if (isSuccess) 
        {
    ...
    return (
        <>
            ...
            <Modal show={showModal} onHide={handleClose} dialogClassName="modal-custom">
                ...
                <Modal.Body dangerouslySetInnerHTML={{ __html: modalTextChangeStoreInfoBase }}/>
                <Modal.Footer>
...
export default ChangeStoreInfoBaseFrom;